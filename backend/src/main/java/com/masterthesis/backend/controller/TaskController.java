...
public class TaskController {
     ...
     * add a new task
     *
     * @param newTasks a new task to be added
     * @return Task
     */
    @PostMapping("")
    public Task addNewTask(Task newTasks) {
        // time: 20 mins
        newTasks.setDone(false);
        newTasks.setDueDate(LocalDate.now());

        return repository.save(newTasks);
    } 
